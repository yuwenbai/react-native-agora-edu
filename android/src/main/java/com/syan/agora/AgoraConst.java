...
public class AgoraConst {
    ...
    public final static String AGRemoteAudioMixingStart = "remoteAudioMixin gStart";
    ...
    public final static String AGChannelError = "channelError";
    public final static String AGJoinSecondChannelSuccess = "joinSecondChannelSuccess";
    public final static String AGLeaveSecondChannel = "leaveSecondChannel";
    public final static String AGUserSecondJoined = "userSecondJoined";
    public final static String AGUserSecondOffline = "userSecondOffline";
    public final static String AGSecondRemoteVideoStateChanged = "secondRemoteVideoStateChanged";
    public final static String AGSecondRemoteAudioStateChanged = "secondRemoteAudioStateChanged";

    //播放器
    public final static String AGMediaPlayerStateOpenCompleted = "mediaPlayerState_open_Completed";
    public final static String AGMediaPlayerStatePlayCompleted = "mediaPlayerState_playback_Completed";
    public final static String AGMediaPlayerStateStoped = "mediaPlayerState_stoped";
    public final static String AGMediaPlayerStateSeeking = "mediaPlayerState_seeking";
}
