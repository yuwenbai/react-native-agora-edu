...
//        }
        ...
        public void onRemoteAudioStats(final RemoteAudioStats stats) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    statsMap.putInt("totalActiveTime", stats.totalActiveTime);
                    statsMap.putString("publishDuration", "");
                    WritableMap map = Arguments.createMap();
                    map.putMap("stats", statsMap);
        ...
        public void onRtcStats(final RtcStats stats) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    statsMap.putDouble("cpuTotalUsage", stats.cpuTotalUsage);
                    statsMap.putDouble("cpuAppUsage", stats.cpuAppUsage);
                    statsMap.putInt("gatewayRtt", stats.gatewayRtt);
                    statsMap.putDouble("memoryAppUsageRatio", stats.memoryAppUsageRatio);
                    statsMap.putDouble("memoryTotalUsageRatio", stats.memoryTotalUsageRatio);
                    statsMap.putInt("memoryAppUsageInKbytes", stats.memoryAppUsageInKbytes);
                    statsMap.putInt("rxPacketLossRate", stats.rxPacketLossRate);
        ...
        public void onLocalVideoStats(final LocalVideoStats stats) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    statsMap.putString("txPacketLossRate", "");
                    statsMap.putString("captureFrameRate", "");
                    WritableMap map = Arguments.createMap();
                    map.putMap("stats", statsMap);
        ...
        public void onLocalAudioStats(final LocalAudioStats rtcStats) {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    map.putString("txPacketLossRate", "");
    ...
    @ReactMethod
    public void createJoinChannel(String channelId, int uid, String token){
        AgoraManager.getInstance().createJoinChannel(new IRtcChannelEventHandler() {
            @Override
            public void onJoinChannelSuccess(final RtcChannel rtcChannel, int uid, int elapsed) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        WritableMap map = Arguments.createMap();
                        map.putString("channelId", rtcChannel.channelId());
                        sendEvent(getReactApplicationContext(), AGJoinSecondChannelSuccess, map);
                    }
                });
            ...
            public void onUserJoined(RtcChannel rtcChannel, int uid, int elapsed) {
                ...
                final  RtcChannel fRtcChannel = rtcChannel;
                final String secondUid = uid + "";
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        WritableMap map = Arguments.createMap();
                        map.putString("uid", secondUid);
                        map.putString("channelId", fRtcChannel.channelId());
                        sendEvent(getReactApplicationContext(), AGUserSecondJoined, map);
                    }
                });
            }
            ...
            public void onChannelError(RtcChannel rtcChannel, int err) {
                ...
                final String secondErr = err + "";
                final  RtcChannel fRtcChannel = rtcChannel;
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        WritableMap map = Arguments.createMap();
                        map.putString("message", "AgoraChannelError");
                        map.putString("errorCode", secondErr);
                        map.putString("channelId", fRtcChannel.channelId());
                        sendEvent(getReactApplicationContext(), AGChannelError, map);
                    }
                });
            ...
            public void onUserOffline(RtcChannel rtcChannel, int uid, int reason) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        map.putString("uid", secondUid);
                        map.putString("channelId", fRtcChannel.channelId());
                        sendEvent(getReactApplicationContext(), AGUserSecondOffline, map);
                    }
                });
            }
            ...
            public void onLeaveChannel(RtcChannel rtcChannel, IRtcEngineEventHandler.RtcStats stats) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        WritableMap map = Arguments.createMap();
                        map.putString("channelId", fRtcChannel.channelId());
                        sendEvent(getReactApplicationContext(), AGLeaveSecondChannel, map);
                    }
                });
            }
            ...
            public void onRemoteVideoStateChanged(RtcChannel rtcChannel, int uid, int state, int reason, int elapsed) {
                ...
                Log.e("wbsTest-->", "onRemoteVideoStateChanged!");
                final int fUid = uid;
                final int fState = state;
                final int fReason = reason;
                final  RtcChannel fRtcChannel = rtcChannel;
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        ...
                        map.putString("channelId", fRtcChannel.channelId());
                        map.putInt("uid", fUid);
                        map.putInt("state", fState);
                        map.putInt("fReason", fReason);
                        sendEvent(getReactApplicationContext(), AGSecondRemoteVideoStateChanged, map);
                    }
                });
            }
            ...
            public void onRemoteAudioStateChanged(RtcChannel rtcChannel, int uid, int state, int reason, int elapsed) {
                ...
                Log.e("wbsTest-->", "onRemoteAudioStateChanged!");
                final int fUid = uid;
                final int fState = state;
                final int fReason = reason;
                final  RtcChannel fRtcChannel = rtcChannel;
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        map.putInt("state", fState);
                        map.putInt("fReason", fReason);
                        sendEvent(getReactApplicationContext(), AGSecondRemoteAudioStateChanged, map);
                    }
                });
            }
    ...
    @ReactMethod
    public void leaveSecondChannel(String channelId, Promise promise){
        int ret = AgoraManager.getInstance().leaveSecondChannel(channelId);
        promise.resolve(ret);
    }

    @ReactMethod
    public void leaveAllChannel(){
        AgoraManager.getInstance().leaveAllChannel();
    }

    @ReactMethod
    public void muteSecondRemoteVideoStream(String channelId, int uid, boolean muted, Promise promise){
        AgoraManager.getInstance().muteSecondRemoteVideoStream(channelId, uid, muted);
    }

    @ReactMethod
    public void muteSecondRemoteAudioStream(String channelId, int uid, boolean muted, Promise promise){
        AgoraManager.getInstance().muteSecondRemoteAudioStream(channelId, uid, muted);
    }

    @ReactMethod
    public void publishSecondChannel(String channelId , Promise promise){
        int ret = AgoraManager.getInstance().publishSecondChannel(channelId);
        promise.resolve(ret);
    }

    @ReactMethod
    public void unPublishSecondChannel(String channelId, Promise promise){
        int ret = AgoraManager.getInstance().unPublishSecondChannel(channelId);
        promise.resolve(ret);
    }
    ...
    public void enableWebSdkInteroperability(boolean enabled, Promise promise) {
        Integer res = rtcEngine.enableWebSdkInteroperability(enabled);
        if (res == 0) {
            promise.resolve(null);
        } else {
            promise.reject("-1", res.toString());
...
//    }
    ...
    @ReactMethod
    public void setUpLocalVideo(int mode, Promise promise) {
        Integer res = AgoraManager.getInstance().setupLocalVideo(mode);
        if (res == 0) {
            promise.resolve(null);
        } else {
            promise.reject("-1", res.toString());
