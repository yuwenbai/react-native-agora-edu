...
declare class RtcEngine {
     ...
     * 创建并加入第二频道
     */
    static createJoinChannel(channel: string, uid: number, token: string): void;
    /**
     *
     *
     * 离开第二频道
     * @return Promise<string>
     */
    static leaveSecondChannel(channel: string): any;
    /**
 *
 *
 * 发布第二频道推流
 */
    static publishSecondChannel(channel: string): any;
    /**
    *
    *
    * 取消第二频道推流
    */
    static unPublishSecondChannel(channel: string): void;
    static leaveAllChannel(): void;
    static muteSecondRemoteAudioStream(channelId: string, uid: number, muted: boolean): void;
}
