...
class RtcEngine {
     ...
     * 创建并加入第二频道
     */
    static createJoinChannel(channel, uid, token) {
     ...
     * @return Promise<string>
     */
    static leaveSecondChannel(channel) {
 ...
 * 发布第二频道推流
 */
    static publishSecondChannel(channel) {
    ...
    * 取消第二频道推流
    */
    static unPublishSecondChannel(channel) {
    ...
    //禁音所有频道 多频道
    static muteSecondRemoteAudioStream(channelId, uid, muted) {
