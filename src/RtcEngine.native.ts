...
class RtcEngine {
     ...
     * 创建并加入第二频道
     */
    static createJoinChannel(channel: string, uid: number, token: string) {
        Agora.createJoinChannel(channel, uid, token);
    }
     ...
     * @return Promise<string>
     */
     static leaveSecondChannel(channel: string) {
        return Agora.leaveSecondChannel(channel);
    }
     ...
     * 发布第二频道推流
     */
     static publishSecondChannel(channel: string) {
        return Agora.publishSecondChannel(channel);
    }
     ...
     * 取消第二频道推流
     */
     static unPublishSecondChannel(channel: string) {
        Agora.unPublishSecondChannel(channel);
    }

    //退出所有频道 多频道
     static leaveAllChannel() {
        Agora.leaveAllChannel();
    }

    //禁音所有频道 多频道
     static muteSecondRemoteAudioStream(channelId: string, uid: number, muted: boolean) {
        Agora.muteSecondRemoteAudioStream(channelId, uid, muted);
    }
}
